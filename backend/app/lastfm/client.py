...
class LastfmClient(BaseHttpClient):
    ...
    async def get_top_artists(self, user: str, period: str = "overall", limit: int = 50) -> list[dict]:
    ...
    async def get_top_albums(self, user: str, period: str = "overall", limit: int = 50) -> list[dict]:
        params = {"user": user, "period": period, "limit": limit}
    ...
    async def get_similar_artists(self, artist: str, limit: int = 20) -> list[dict]:
