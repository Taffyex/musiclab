<script lang="ts">
	...
	let expandedRelease = $state<number | null>(null);
	
	function toggleCredits(id: number) {
				...
				<div class="release-row">
					<div class="release-main flex items-center gap-md">
						...
						<div class="actions ml-auto">
							<button class="credits-btn" onclick={() => toggleCredits(release.id)}>
								{expandedRelease === release.id ? 'Hide Credits' : 'Credits'}
							</button>
						</div>
					</div>
